    ...
    if (searchable && isSearchActive) {
      content = (
        <TextInput
          ...
          style={[styles.titleText, { marginLeft: 0, fontFamily: 'GoogleSans-Medium', color: '#aaa' }]}
      ...
      content = (
        <Text numberOfLines={1} style={[styles.titleText, {fontFamily: 'GoogleSans-Medium', fontWeight: '1000'}]}>
          {centerElement}
        </Text>
      );
    } else {
